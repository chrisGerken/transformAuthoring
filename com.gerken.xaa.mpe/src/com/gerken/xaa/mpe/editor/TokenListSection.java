...
public class TokenListSection extends AbstractListSection implements IConstraintListener {
	...
	protected void createClient(Section section, FormToolkit toolkit) {
		...
		moveToSameButton = toolkit.createButton(buttonContainer, "Move", SWT.PUSH);
