...
public class _jet_widgetlistener_1 implements JET2Template {
    private static final String _jetns_c = "org.eclipse.jet.controlTags"; //$NON-NLS-1$

    public _jet_widgetlistener_1() {
        super();
    }
    ...
    public void generate(final JET2Context context, final JET2Writer __out) {
        ...
        out.write(" implements SelectionListener {");  //$NON-NLS-1$        
        out.write(NL);         
        out.write("\t\tpublic void widgetDefaultSelected(SelectionEvent e) { exec(); }");  //$NON-NLS-1$        
        out.write(NL);         
        out.write("\t\tpublic void widgetSelected(SelectionEvent e) { exec(); }");  //$NON-NLS-1$        
        out.write(NL);         
        out.write("\t\tprivate void exec() {");  //$NON-NLS-1$        
        out.write(NL);         
        out.write("\t\t\tif (isFillingFields()) { return; }");  //$NON-NLS-1$        
        out.write(NL);         
        out.write("\t\t\tString value = String.valueOf(");  //$NON-NLS-1$        
        ...
        out.write(".getSelection());");  //$NON-NLS-1$        
        out.write(NL);         
