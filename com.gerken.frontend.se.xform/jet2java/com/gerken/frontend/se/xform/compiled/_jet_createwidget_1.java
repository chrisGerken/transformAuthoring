...
public class _jet_createwidget_1 implements JET2Template {
    private static final String _jetns_c = "org.eclipse.jet.controlTags"; //$NON-NLS-1$

    public _jet_createwidget_1() {
        super();
    }
    ...
    private static final TagInfo _td_c_get_6_65 = new TagInfo("c:get", //$NON-NLS-1$
            6, 65,
            new String[] {
                "select", //$NON-NLS-1$
            },
    ...
    public void generate(final JET2Context context, final JET2Writer __out) {
        ...
        out.write(" = toolkit.createButton(client,\"");  //$NON-NLS-1$        
        ...
        out.write(".addSelectionListener(new ");  //$NON-NLS-1$        
        RuntimeTagElement _jettag_c_get_6_65 = context.getTagFactory().createRuntimeTag(_jetns_c, "get", "c:get", _td_c_get_6_65); //$NON-NLS-1$ //$NON-NLS-2$
        _jettag_c_get_6_65.setRuntimeParent(null);
        _jettag_c_get_6_65.setTagInfo(_td_c_get_6_65);
        _jettag_c_get_6_65.doStart(context, out);
        _jettag_c_get_6_65.doEnd();
        out.write("());");  //$NON-NLS-1$        
        out.write(NL);         
    }
}
